...
link = 'https://vpikalova.github.io/KMAD-bot2023/data/'
                      ...
                      {'kafedra': {'text': ['start_kafedra.txt'],
                                   ...
                                   'next_menu': {'vykladachi': {'text': ['start_kafedra_vykladachi_with_url.txt'],
                                                 ...
                                                 'perevagu': {'text': ['start_kafedra_perevagu.txt'],
                                                                 'photo': ['start_kafedra_perevagu_urls_photo.txt']},
                       ...
                       'mozhlyvosti': {'text': ['start_mozhlyvosti.txt'],
                                       ...
                                       'next_menu': {'proektnnavch': {'text': ['start_mozhlyvosti_proektnnavch_with_ulr.txt'],
                                                     ...
                                                     'pratsevlashuv': {'text': ['start_mozhlyvosti_pratsevlashtuv.txt'],
                                                                       'photo': ['start_mozhlyvosti_pratsevlashtuv_urls_photo.txt']},
...
def perevagu(update: Update, context: CallbackContext):
    ...
    query.message.reply_text(text='\n'.join(
        content_lines[0:1]), parse_mode="HTML")
    query.message.reply_photo(link + photos[0])
    query.message.reply_text(text='\n'.join(
        content_lines[2:8]), parse_mode="HTML")
    query.message.reply_text(text='\n'.join(
        content_lines[8:14]), parse_mode="HTML")
    query.message.reply_text(text='\n'.join(
        content_lines[14:22]), parse_mode="HTML")
    query.message.reply_text(text='\n'.join(
        content_lines[22:24]), parse_mode="HTML")
    query.message.reply_text(text='\n'.join(
        content_lines[24:26]), parse_mode="HTML")
    query.message.reply_photo(link + photos[1])
    query.message.reply_text(text='\n'.join(
        content_lines[27:39]), parse_mode="HTML")
    query.message.reply_text(text='\n'.join(
        content_lines[39:41]), parse_mode="HTML")
    query.message.reply_photo(link + photos[2])
    query.message.reply_text(text='\n'.join(
        content_lines[42:54]), parse_mode="HTML")
    query.message.reply_photo(link + photos[3])
    query.message.reply_photo(link + photos[4])
    query.message.reply_text(text='\n'.join(
        content_lines[53:75]), parse_mode="HTML")
    #query.message.reply_photo(link + photos[4])
    query.message.reply_text(text='\n'.join(
        content_lines[75:]), reply_markup=reply, parse_mode="HTML")  
...
def istoria(update: Update, context: CallbackContext):
    ...
    for i in range(len(photos)):
        ...
        print(text_message)
        query.message.reply_text(text= text_message, parse_mode="HTML")
        link_photo = link + photos[i]
        print(link_photo)
        query.message.reply_photo(link_photo)
    query.message.reply_text(text=content_list[-1], reply_markup=reply, parse_mode="HTML")
...
def vypusnyki(update: Update, context: CallbackContext):
    ...
    query.message.reply_photo(link + photos[1])
    query.message.reply_text(
        text='\n'.join(content_lines[3:]), reply_markup=reply, parse_mode="HTML")
# -------------------------------**  end block kafedra  **----------------------------
